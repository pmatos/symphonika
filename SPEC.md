...
direct-child abort behavior. A caller queued on the shared per-cache fetch serializer checks the
signal after reaching the head of the queue and does not begin new Git work after its deadline.
