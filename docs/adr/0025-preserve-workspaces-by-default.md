...
ADR 0067 narrows this decision for terminal Routine Firing workspaces only: outcome-aware,
service-configured age retention reclaims their registered worktrees after a forensic window while
preserving Run Store and state-root evidence. Issue Workspaces remain governed by this ADR.
