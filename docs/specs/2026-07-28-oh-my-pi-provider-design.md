...
enforces the ready frame's advertised physical limit and the smaller of its advertised logical
limit and Symphonika's fixed 64 MiB daemon-local ceiling. Advertising more remains compatible, but
declaring a logical frame above the effective limit is malformed. The adapter also rejects
